/**
 * RFC-7807 Problem handling, mirrored from the S1 SDK's
 * `packages/sdk-ts/src/errors.ts`. The MCP tool surface must relay the
 * backend's Problem body as *structured* error data (docs/MCP_SERVER.md's
