/**
 * Thin fetch-based HTTP client, mirrored from the TypeScript SDK's
 * HTTP client module. It holds the tenant's API key once
 * (the server documentation: "the MCP server authenticates once... every tool call
