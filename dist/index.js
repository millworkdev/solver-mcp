 ...
 * tool call (docs/MCP_SERVER.md -- the MCP server authenticates once; there
...
function readBackendOptionsFromEnv() {
    ...
    if (!apiKey || !baseUrl) {
        throw new Error("SolverAPI MCP server requires SOLVERAPI_API_KEY and SOLVERAPI_BASE_URL " +
