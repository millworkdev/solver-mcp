 ...
 * tool (docs/MCP_SERVER.md -- "the MCP server authenticates once... every
 ...
 * entrypoint (src/index.ts) attaches stdio. Keeping them separate lets a test
 ...
 * error data, per docs/MCP_SERVER.md: a backend RFC-7807 Problem is surfaced
