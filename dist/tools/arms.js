 ...
 * backend (arms CRUD is live). Both map 1:1 to a docs/PRODUCT_CONTRACT.md §3
 * endpoint and are thin passthroughs -- no shaping beyond what the API
 * returns, per docs/MCP_SERVER.md's "no hidden logic" rule.
 */
// Shared enum fragments, kept identical to the S1 SDK's ArmKind/CostClass/
 ...
 * write-shape (docs/PRODUCT_CONTRACT.md §2.1); required at the top level are
 * the kind-agnostic fields, matching docs/MCP_SERVER.md's register schema.
