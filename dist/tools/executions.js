 ...
 */
// Inlined from docs/PRODUCT_CONTRACT.md §2.3 ExecutionRequest. The doc's
 ...
 * THIS SCHEMA (not merely in prose): docs/PRODUCT_CONTRACT.md §1 makes the
 ...
 * guarantee (docs/MCP_SERVER.md's "Idempotency is not optional"). Keeping it
        ...
        properties: {
            ...
            idempotency_key: {
                ...
                description: "A unique request ID for this call, sent as the Idempotency-Key header " +
                    "(docs/PRODUCT_CONTRACT.md §1). Hard-required by this schema, not prose -- " +
                    "an MCP client cannot construct a valid call without it.",
            },
        },
    },
